...
public class TestModelo {
	...
	public void testGrafo1() throws Exception {
		...
		// TODO: Ojo que el t arranca de 0!!
		assertEquals(m.getSolucion(), 2);
	}
	...
	public void testArbol() throws Exception {
		...
		assertEquals(m.getSolucion() + 1, calcularT(g));
	}
	...
	public void testCalcularT() throws Exception {
		...
		assertEquals(m.getSolucion(), calcularT(g));
	}
